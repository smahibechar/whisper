...
{R}""")
API_TOKEN = input('Telegram BOT Token ==> ')
...
def Ruks():
    ...
    data = 'brand=VISA&country=UNITED+STATES&bank=1880+BANK&cvv=&year=random&range=500+-+1000&amount=10&pin=on'
